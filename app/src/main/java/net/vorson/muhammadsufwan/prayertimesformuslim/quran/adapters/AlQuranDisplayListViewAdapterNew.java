package net.vorson.muhammadsufwan.prayertimesformuslim.quran.adapters;
...
import net.vorson.muhammadsufwan.prayertimesformuslim.quran.FontManager;
import net.vorson.muhammadsufwan.prayertimesformuslim.quran.QuranView;
import net.vorson.muhammadsufwan.prayertimesformuslim.quran.RichTextView;
import net.vorson.muhammadsufwan.prayertimesformuslim.quran.ScrollingStyleQuranActivity;
import net.vorson.muhammadsufwan.prayertimesformuslim.quran.StaticObjects;
import net.vorson.muhammadsufwan.prayertimesformuslim.quran.TafsirTranslationManager;
import net.vorson.muhammadsufwan.prayertimesformuslim.quran.TextRendererNew;
import net.vorson.muhammadsufwan.prayertimesformuslim.quran.interfaces.AlQuranDisplayListViewAdapterListener;
import net.vorson.muhammadsufwan.prayertimesformuslim.quran.models.WordMeaningsRectObj;

...
import net.vorson.muhammadsufwan.prayertimesformuslim.quran.data.TafsirTranslationObj;
import net.vorson.muhammadsufwan.prayertimesformuslim.quran.data.XMLParser;
import net.vorson.muhammadsufwan.prayertimesformuslim.quran.interfaces.IDownloadTafsirManagerListener;
...
public class TafsirTranslationManager implements net.vorson.muhammadsufwan.prayertimesformuslim.quran.data.DownloadListener {

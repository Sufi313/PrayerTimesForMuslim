...
public class SettingsManager {
    ...
    public static void clearPreferances() {
        Editor edit = PreferenceManager.getDefaultSharedPreferences(App.getInstance()).edit();
        edit.clear();
        edit.commit();
    }

    public static boolean isRunBefore() {
        return PreferenceManager.getDefaultSharedPreferences(App.getInstance()).getBoolean(RUN_ONCE, false);
    }
}

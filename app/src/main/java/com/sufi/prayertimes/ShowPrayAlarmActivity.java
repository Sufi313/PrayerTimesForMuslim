...
import com.sufi.prayertimes.customWidget.swipeButton.OnStateChangeListener;
import com.sufi.prayertimes.customWidget.swipeButton.SwipeButton;
...
public class ShowPrayAlarmActivity extends AppCompatActivity implements Constants, OnStateChangeListener, MediaPlayer.OnCompletionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_pray_alarm);
